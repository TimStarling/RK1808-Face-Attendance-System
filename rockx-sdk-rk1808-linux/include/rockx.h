 ...
 *
 * Functions  函数名               | The Value of rockx_module_t Used on creating 模型使用的枚举值                           | Description                 | Define At          |
 * ----------------------------------|------------------------------------------------------------------------|-----------------------------|--------------------|
 ...
 * @ref rockx_face_detect  人脸识别    | @ref ROCKX_MODULE_FACE_DETECTION                                       | Face Detection              | face.h             |
 * @ref rockx_face_landmark  人脸关键点（特征）         | @ref ROCKX_MODULE_FACE_LANDMARK_68 / @ref ROCKX_MODULE_FACE_LANDMARK_5 | Face KeyPoint Landmark      | face.h             |
 * @ref rockx_face_pose              |                                                                        | Face Angle                  | face.h             |
 * @ref rockx_face_align             | @ref ROCKX_MODULE_FACE_LANDMARK_5                                      | Face Align                  | face.h             |
 * @ref rockx_face_recognize 人脸识别       | @ref ROCKX_MODULE_FACE_RECOGNIZE                                       | Face Recognition            | face.h             |
...
/// \param handle [out] 已创建模块的句柄
/// \param m [in] RockX模块枚举(@ref rockx_module_t)
/// \param config [in] RockX模块配置(@ref rockx_config_t)
/// \param config_size [in] 配置结构体的大小
